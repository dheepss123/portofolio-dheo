            ...
            <div class="grid grid-cols-1 md:grid-cols-2 items-center gap-y-10 lg:gap-y-0">
                <div>
                    ...
                    <p class="text-paragraph leading-7 mt-4 mb-7 max-w-md">
                        I’m from Indonesia and I’m a <span class="text-white font-medium">Backend Engineer</span>.
                        I’ve worked 5 years in <span class="text-white font-medium">Google and Apple</span> as a Backend Engineer.
                        I’ve been freelancing for the last 3 years and right now I am
                        looking forward to collaborate with you!
                    </p>
                    <div class="flex items-center gap-x-3">
                        <a href="mailto:dheepss321@gmail.com" class="flex items-center gap-x-3">
                        ...
                        <a target="_blank" href="https://drive.google.com/file/d/1T59I1LOCELa8fwASPzPLV2ngEfiKe0Dr/view?usp=sharing" class="flex items-center gap-x-3">
                ...
                <div class="relative w-10/12 sm:w-6/12 md:w-11/12 lg:w-8/12 xl:w-7/12 mx-auto md:mx-0 md:ml-auto max-w-xs">
                    ...
                    <BoxDecoration class="absolute top-36 left-2">
                        <img class="w-16" src="/images/tf.png" alt="Figma">
                    </BoxDecoration>
                    <BoxDecoration class="absolute top-8 right-6">
                        <img src="/images/python.png" alt="Figma">
                    </BoxDecoration>
